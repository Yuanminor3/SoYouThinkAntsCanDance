...
export class AnimatedBone extends gfx.Node3
{
    ...
    applyPose(pose: Pose): void
    {
        ...
        // ***** Part 1: Set the this.boneSpaceToParentBoneSpace matrix for the bone.
        ...
        // Retrieve the transformation for this bone from the pose.
        const boneTransformation = pose.getJointRotationMatrix(this.name);
        
        // Calculate the localToParent transformation matrix
        // bone space -> joint space
        // multiple boneTransformation
        // joint space -> bone space
        // bone space -> parenet bone space
        const localToParentMatrix = gfx.Matrix4.multiplyAll(this.boneSpaceToParentBoneSpace, this.jointSpaceToBoneSpace, boneTransformation, this.boneSpaceToJointSpace);

        // Set the localToParent matrix for the bone.
        this.setLocalToParentMatrix(localToParentMatrix, false);
