...
{    
    ...
    onSkeletonsAndMotionClipsLoaded(): void
    {
        ...
        this.balletDanceMotions[0].trimFront(200);
        ...
        // clip 2
        this.balletDanceMotions[1].trimFront(80);
        this.balletDanceMotions[1].trimBack(20);
        // clip 3 
        this.balletDanceMotions[2].trimFront(380);
        this.balletDanceMotions[2].trimBack(0);
        // clip 4
        this.balletDanceMotions[3].trimFront(450);
        this.balletDanceMotions[3].trimBack(10);
        // clip 5
        this.balletDanceMotions[4].trimFront(20);
        this.balletDanceMotions[4].trimBack(20);
